...
class F extends React.Component {
  ...
  componentDidMount() {
    ...
    const getRates = async () => {
      ...
      const response = await fetch('https://gw.alipayobjects.com/os/basement_prod/70cde3be-22e8-4291-98f1-4d5a5b75b62f.json')
      ...
      const container = document.getElementById('axt');
      ...
      if (typeof window !== 'undefined')
        window.onresize = () => {
          ...
          const edges = this.state.items.edges;
          const nodes = this.state.items.nodes;
